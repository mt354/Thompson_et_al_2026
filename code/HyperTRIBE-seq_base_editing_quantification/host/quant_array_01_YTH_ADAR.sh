...
bedfile=/cwork/mt354/MGT279_TRIBE_SEQ/bullseye/host/edit_sites/summary_beds/YTH_ADAR_all.bed
matrix=/cwork/mt354/MGT279_TRIBE_SEQ/bullseye/host/matrix_files

module load Anaconda3/2024.02
source activate $env

# List all bed files in array, zero-indexed
matrixfiles=(${matrix}/{ctl*,yth*}gz)
...
perl $SOFTWARE/quantify_sites.pl \
    --bed "$bedfile" \
    --EditedMatrix "${matrix}" \
    --outfile "edit_sites/quant_results/${prefix}.yth.out" \
    --editType A2I \
    --minEdit 1 \
    --maxEdit 100 \
