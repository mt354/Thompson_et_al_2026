...
cd /cwork/mt354/MGT450_HCV_TRIBE_rerun/MGT450_hcv_bullseye/
mkdir -p matrix_files

cd /cwork/mt354/MGT450_HCV_TRIBE_rerun/MGT450_hcv_align/star_salmon/
...
#path to where software was downloaded
...
source activate /hpc/group/hornerlab/mt354/miniconda3/envs/Bullseye
...
mv $STEM.matrix* /cwork/mt354/MGT450_HCV_TRIBE_rerun/MGT450_hcv_bullseye/matrix_files
